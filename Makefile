...
CXX = aarch64-linux-gnu-gxx
LD = aarch64-linux-gnu-ld

#EXTRA_CFLAGS += --target=aarch64-linux-android21
#EXTRA_CFLAGS += -I /usr/src/linux-headers-5.3.0-42-generic/include

#EXTRA_CFLAGS += -I /home/mike/linux/include
#EXTRA_CFLAGS += -I /mnt/sda1/linux/gcc-linaro-4.9.4-2017.01-x86_64_aarch64-linux-gnu/aarch64-linux-gnu/libc/usr/include
...
###################### Platform Related #######################
CONFIG_PLATFORM_ARM64_MOTO_G7 = y
...
ifeq ($(CONFIG_PLATFORM_ARM64_MOTO_G7), y)
EXTRA_CFLAGS += -DCONFIG_LITTLE_ENDIAN
#EXTRA_CFLAGS += -DCONFIG_IOCTL_CFG80211 -DRTW_USE_CFG80211_STA_EVENT
ARCH := arm64
KVER := 4.9.112-perf+
KSRC := /home/mike/linux
MODDESTDIR := ls /mnt/runtime/default/emulated/lib/modules/4.9.112-perf+/kernel/drivers/net/wireless/
INSTALL_PREFIX :=
STAGINGMODDIR := /mnt/runtime/default/emulated/lib/modules/4.9.112-perf+/kernel/drivers/staging
endif
